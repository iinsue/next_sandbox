  ...
  return (
    <>
      <div>
        ...
        {
          /* 
            Since the latest page's data potentially sticks around between page request,
            we can use `isFetching` to show a background loading indicator since our `status==='pending'` state won't be triggered
        */
